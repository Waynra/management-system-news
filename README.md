...
Backend untuk manajemen berita dengan pemrosesan asynchronous. API menulis ke MySQL, mengantrikan pekerjaan ke RabbitMQ, lalu worker mengindeks ke Elasticsearch untuk pencarian cepat. case PT Rudex Teknologi Indonesia
